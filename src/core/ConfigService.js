...
module.exports = class ConfigService {
  ...
  loadUniBan() {
    ...
    request('https://github.com/LegitSoulja/ogarul/tree/master/src/uniban.txt', function(error, response, body) {
      var data = '';
  ...
  loadCustomSkin() {
    try {
      if (!fs.existsSync(__dirname + '/../customskins.txt')) {
        ...
        request('https://github.com/LegitSoulja/ogarul/tree/master/src/customskins.txt', function(error, response, body) {
          if (!error && response.statusCode == 200) {
